...
# UMLtoUPPAAL
# Reads a soil-script from [infile] and outputs a UPPAAL model to [outfile]. [executorCount] and [queueLength] are used as additional parameters of the translation. If [verbose] lots of extra output is printed to stdout.
